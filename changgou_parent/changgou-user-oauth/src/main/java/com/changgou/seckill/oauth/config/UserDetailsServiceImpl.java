package com.changgou.seckill.oauth.config;

import com.changgou.seckill.oauth.util.UserJwt;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        com.changgou.seckill.user.pojo.User user = userFeign.findUserInfo(username);
        //创建User对象
